...
#include "PTSCommon.h"
	...
	fieldDef	UnicodeString128Table_FieldDefs[] = {
...
//		"rowID",									8,	ROWID_FT,	Persistant_PT,
		...
		"string",									256,USTRING128_FT,	Persistant_PT, 
	};

// defined here so other folks can get to it	
U32			cbUnicodeString128Table_FieldDefs = 
				sizeof(UnicodeString128Table_FieldDefs);