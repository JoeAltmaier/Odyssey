...
//
// Description:
// This file contains system constants common to both the application and
// the actual Nucleus PLUS components.  This file also contains data
// structure definitions that hide internal information from the application.
//
//
// $Log: /Gemini/Include/Nucleus/Nucleus.h $
// 
// 12    7/20/99 10:41a Skasargod
// Moved the setting of interrupt mask to int_eval.s
// 
// 11    7/13/99 12:18p Rkondapalli
// Changed INT Mask for suporting interrupt driven TRK
// 
// 10    6/30/99 3:18p Skasargod
// When the System comes up only INT 5 and SW0 and SW1 are
// enabled, reset of them are enabled as and when we call
// NU_Register_LISR()
// 
// 9     6/17/99 11:28a Skasargod
// Changed the value of NU_MAX_VECTORS and NU_MAX_LISRS from
// 8 to 21
// 
// 8     6/14/99 4:05p Skasargod
// Added #define for NU_ENABLE_R7KINTERRUPTS
// 
// 7     5/10/99 1:15p Ewedel
// Changed definition of VOID from typedef to #define.  The former is not
// legal for use in empty function parameter lists.
//
// 04/30/99 Sudhir Kasargod: 
// 				Enabled Interrupt 4, NU_ENABLE_INTERRUPTS is 0xFF00 now
// 10/06/98 Jeff Nespor: Modifications previously made to R4640 source.
//                       - Check before redefining VOID.
//                       - Define NU_NO_ERROR_CHECKING for performance test.
// 06/14/99 Sudhir Kasargod
// 			- Added #define for NU_ENABLE_R7KINTERRUPTS 
// 06/17/99 Sudhir Kasargod
// 			¯ Changed NU_MAX_VECTORS and NU_MAX_LISRS from 8 to 12
/*************************************************************************/
...
/* FILE NAME                                            VERSION          */
/*                                                                       */
/*      nucleus.h                               PLUS/IDT4640/50/GNU 1.6  */
/*                                                                       */
/* COMPONENT                                                             */
/*                                                                       */
/*      System Constants                                                 */
...
/*         NAME            DATE                    REMARKS               */
/*                                                                       */
/*      S. Nguyen       06-30-98      Created version 1.0 for IDT5000    */
/*                                                                       */
/*************************************************************************/
...
#ifndef __VOID
#define VOID                    void   /* #define instead of typedef for GH */
#define __VOID
#endif
...
/* Inhibit error checking for performance analysis.  */
...
#define         NU_MIN_STACK_SIZE               380
#define         NU_MAX_NAME                     8
#define         NU_MAX_VECTORS                  12
#define         NU_MAX_LISRS                    12
...
#define         NU_DISABLE_INTERRUPTS           0x0000
