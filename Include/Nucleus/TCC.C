...
/*      R. Pfaff -                                                       */
/*      D. Lamie        03-18-1994      Verified version 1.1             */
/*      M. Trippi       12-19-1995      Changed the "task" parameter to  */
/*                                        "task_ptr" in the              */
...
/*      R. Pfaff -                                                       */
/*      D. Lamie        03-18-1994      Verified version 1.1             */
/*      S. Murrill      06-01-1996      Checked to see whether           */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        02-01-1994      Added logic to clear the timer   */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        03-01-1994      Modified call to suspend the     */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        03-01-1994      Modified protection logic,       */
/*                                        resulting in version 1.1       */
/*      R. Pfaff -                                                       */
/*      D. Lamie        03-18-1994      Verified version 1.1             */
/*                                                                       */
...
/*      longer ready, this request is ignored.                           */
/*                                                                       */
/* AUTHOR                                                                */
/*                                                                       */
/*      William E. Lamie, Accelerated Technology, Inc.                   */
...
R1 TC_TCB      *task;                       /* Task control block ptr    */
         ...
         (task -> tc_priority != (DATA_ELEMENT) TCD_Highest_Priority)))
    {
        ...
        *(task -> tc_priority_head) =  task -> tc_ready_next;
        ...
        /* Insure that the task has a fresh time slice the next time it
           is scheduled.  */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        03-01-1994      Added protection logic prior to  */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        03-01-1994      Added register optimizations,    */
...
/*      W. Lamie        03-01-1993      Created initial version 1.0      */
/*      D. Lamie        04-19-1993      Verified version 1.0             */
/*      W. Lamie        03-01-1994      Added appropriate casting,       */
/*                                        resulting in version 1.1       */
/*      R. Pfaff -                                                       */
/*      D. Lamie        03-18-1994      Verified version 1.1             */
/*                                                                       */
...
INT             old_level;
    ...
    if (new_lisr)
    {
        ...
        else
        {
            ...
            index =  1;
            while ((TCD_LISR_Pointers[index] != NU_NULL) &&
                                                        (index < NU_MAX_LISRS))
                index++;
	...
	/* if vector corresponds to a HW Interrupt enable the Interrupt */
	if ( (status == NU_SUCCESS) && (vector <= 9)) {
		old_level = TCT_Control_Interrupts(0);
		old_level |= ( 0x400 << vector);
		TCT_Control_Interrupts(old_level);
	}
