...
/*      TCD_R7KInterrupt_Level              Enable interrupt level for   */
/*                                          R7K Interrupts
...
/*      W. Lamie        11-01-1993      Added variable to save last      */
/*                                        unhandled interrupt in system  */
/*                                        error conditions, resulting in */
/*                                        version 1.0a                   */
/*      D. Lamie        11-01-1993      Verified version 1.0a            */
/*      W. Lamie        03-01-1994      Change schedule protection to a  */
...
#include        "int_pri.h"                 /* Interrupt Priority defines */ 
...
/* TCD_R7KInterrupt_Level is a variable that contains the enabled interrupt 
   level for R7000 MIPS. */
   
INT             TCD_R7KInterrupt_Level = CONFIG_ICR_VS;
...
/* TCD_XXXX_COUNTER is a variable that contains the count of timer ticks
   for each execution mode.  Incremented in Int_eval.s  */

INT				TCD_IDLE_COUNTER;
INT				TCD_HISR_COUNTER;
INT				TCD_TASK_COUNTER;