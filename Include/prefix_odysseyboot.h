 ...
 */
#define	INCLUDE_ODYSSEY	 1            // Flag for running on ODYSSEY systems.
#undef	INCLUDE_EV64120		      // Flag for running on EV64120 systems.
#define	CONFIG_BOOT		1
#undef CONFIG_HBC		
#define CONFIG_E2			// Flag for Configuring E2 boards
#undef CONFIG_E1			// Flag for Configuring E1 boards
...
#define REG_TYPE	unsigned long long	// Register type
...
#define REG_TYPE	unsigned long		// Register type 	
...
#ifdef __fpu__
#ifdef __MIPS_ISA2__
#define	FREG_TYPE	unsigned long long	// 64 bit registers
#define LOADF		ldc1
#define STOREF		sdc1
#else
#define FREG_TYPE 	unsigned long		// 32 bit registers
#define LOADF		lwc1
#define STOREF		swc1
#endif
#endif
