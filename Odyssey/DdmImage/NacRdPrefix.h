...
//
// Description:
// This is NAC RAM Disk Build Prefix file.  This seems to be the best place for
...
// 08/03/99 Michael G. Panas: Create version from NacPrefix.h
/*************************************************************************/
...
#define NACRD_BUILD			// NAC Ram Disk test build
//#define NONIC				// no NIC in this config
//#define FCP_SINGLE_BUILD	// first version is single also
#define SCSI_TARGET_SERVER	// need this
#define RD_BUILD			// and need this
