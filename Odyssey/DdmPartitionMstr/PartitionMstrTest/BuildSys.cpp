...
CLASSENTRY("DDM_PMSTR", 10240,1024,DdmPartitionMstr);
CLASSENTRY("DDM_PMSTR_TEST", 10240,1024,PartitionMstrTest);
...
SYSTEMENTRY("DDM_PMSTR" );	// Must be first!
SYSTEMENTRY("DDM_PMSTR_TEST" );	// Must be first!
