...
//
ERC DdmPongSlave::Enable(Message *pMsgEnable)
{
	ERC erc;
...
// .Quiesce -- End-it-all --------------------------------------------------DdmPongSlave-
//
ERC DdmPongSlave::Quiesce(Message *pMsgQuiesce) {

	Tracef("ENTER DdmPongSlage::Quiesce\n");
	Reply(pMsgQuiesce,OK);
