...
// 
// Description:
// 	This file is implementation for the Board module. 
// 
// $Log: /Gemini/Odyssey/ExceptionMaster/Board.cpp $
// 
// 2     9/08/99 8:14p Hdo
...
STATUS Board::performTask(XM_CONTEXT	*pXMContext)
{
	TRACE_ENTRY();
	STATUS status;
...
void Board::StartShutdown()
{
	TRACE_ENTRY();
}

void Board::RunDegradedMode()
{
	TRACE_ENTRY();
}

void Board::RunNormal()
{
	TRACE_ENTRY();
}
