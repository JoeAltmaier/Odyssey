...
// 
// Description:
// 	This file is implementation for the Drives module. 
// 
// $Log: /Gemini/Odyssey/ExceptionMaster/Drives.cpp $
// 
// 2     9/08/99 8:14p Hdo
...
STATUS Drives::performTask(XM_CONTEXT	*pXMContext)
{
	TRACE_ENTRY();
	STATUS status;
