...
/*************************************************************************/
// FF_Error_Injection globals.
/*************************************************************************/
FF_Error_Injection::Test_Entry *FF_Error_Injection::m_p_test_entry;
unsigned FF_Error_Injection::m_next;
unsigned FF_Error_Injection::m_seed;

/*************************************************************************/
// Allocate memory for object.
/*************************************************************************/
Status FF_Error_Injection::Allocate()
{
#ifdef _WIN32
	m_p_test_entry = (Test_Entry *)malloc(sizeof(Test_Entry) * FF_Error_Test_Last);
#else
...
/*************************************************************************/
int FF_Error_Injection::Test_Error(int condition, FF_Error_Test_Name test_name)
{
	...
	if (p_test_entry->frequency_counter)
	{
		...
		if (--p_test_entry->frequency_counter == 0)
		{
			...
			p_test_entry->error_injection_counter++;
...
// configuration file.
/*************************************************************************/
Status FF_Error_Injection::Set_Config_Options(FF_CONFIG *p_config)
{
