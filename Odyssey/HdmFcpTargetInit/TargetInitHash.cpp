...
//
// File: TargetInitHash.cpp
// 
// Description:
// This module has the FCP Target Hash Table methods
// 
// Update Log:
//	$Log: /Gemini/Odyssey/HdmFcpTargetInit/TargetInitHash.cpp $
// 
// 1     8/23/99 2:20p Mpanas
// Changes to support Export Table States
// - New files
// 
// 
// 08/23/99 Michael G. Panas: Create file from TargetHash.cpp
/*************************************************************************/
...
/*************************************************************************/
VDN HdmFcpTargetInit::FCP_Find_Next_Virtual_Device(void *pCtx, U32 key)
{
	VDN				 vdNext;
	Xlt				*pX;
	pHandler_t 		 Handler;
	
	TRACE_ENTRY(HdmFcpTargetInit::FCP_Find_Next_Virtual_Device);
...
/*************************************************************************/
U32 HdmFcpTargetInit::Hash(U32 key)
{
...
/*************************************************************************/
U32 HdmFcpTargetInit::Add_Hash_Entry(U32 key, void *entry)
{
	U32			 hash;
	Xlt			*pX;
	
 	TRACE_ENTRY(HdmFcpTargetInit::Add_Hash_Entry);
...
/*************************************************************************/
void *HdmFcpTargetInit::Remove_Hash_Entry(U32 key)
{
	Xlt			*pX, *pXlast;
...
/*************************************************************************/
void * HdmFcpTargetInit::Find_Hash_Entry(U32 key)
{
	Xlt			*pX;
...
/*************************************************************************/
void HdmFcpTargetInit::Set_Handler(void *p) {
	Xlt			*pX = (Xlt *)p;
...
/*************************************************************************/
U32 HdmFcpTargetInit::Handle_Busy_Resp(void *pContext, void *pX)
{
	STATUS			status;

 	TRACE_ENTRY(HdmFcpTargetInit::Handle_Busy_Resp);
...
/*************************************************************************/
U32 HdmFcpTargetInit::Handle_Error_Resp(void *pContext, void *pX)
{
	STATUS			status;
	REQUEST_SENSE	abort_sense = {RESPONSE_CODE, 0, SENSE_NOT_READY, 0,0,0,0,
 	...
 	TRACE_ENTRY(HdmFcpTargetInit::Handle_Error_Resp);
...
/*************************************************************************/
U32 HdmFcpTargetInit::Handle_Cmd_Resp(void *pContext, void *p)
{
	Xlt			*pX = (Xlt *)p;

 	TRACE_ENTRY(HdmFcpTargetInit::Handle_Cmd_Resp);
...
// partner.
/*************************************************************************/
U32 HdmFcpTargetInit::Handle_Trigger_Resp(void *pContext, void *p)
{
	Xlt			*pX = (Xlt *)p;

 	TRACE_ENTRY(HdmFcpTargetInit::Handle_Trigger_Resp);
