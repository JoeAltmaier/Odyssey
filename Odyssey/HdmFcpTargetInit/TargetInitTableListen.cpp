...
//
// File: TargetInitTableListen.cpp
// 
// Description:
...
// 
// Update Log:
//	$Log: /Gemini/Odyssey/HdmFcpTargetInit/TargetInitTableListen.cpp $
// 
...
// 
// 
// 08/23/99 Michael G. Panas: Create file from TargetTableListen.cpp
/*************************************************************************/
...
/*************************************************************************/
STATUS 	HdmFcpTargetInit::TI_StartListen(U32 LoopInstance)
{
	TL_TBL_CONTEXT *pTC;
	STATUS status;
	
	TRACE_ENTRY(TI_StartListen);
	...
	status = m_Listen->Initialize(
		...
		(pTSCallback_t)&TI_ExportListenUpdate,	// pTSCallback_t pCallback,
		pTC									// void*	pContext
	);
...
/*************************************************************************/
// TI_ExportListenUpdate
// Called when a listen callback for the Export Table happens.
/*************************************************************************/
STATUS	HdmFcpTargetInit::TI_ExportListenUpdate(void *pClientContext, STATUS status)
{
	...
	TRACE_ENTRY(TI_ExportListenUpdate);
