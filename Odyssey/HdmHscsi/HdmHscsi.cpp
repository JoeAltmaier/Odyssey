...
// 
// Update Log:
//	$Log: /Gemini/Odyssey/HdmHscsi/HdmHscsi.cpp $
// 
...
//	Id->ISP_Regs = (VOID *)Id->HSCSI_config.base_ISP_address; 
	...
	Id->Regs = (VOID *)((UNSIGNED)Id->ISP_Regs - 0x80000000); // conversion for HBC
	// may need different Id->Regs conversion for eval boards
