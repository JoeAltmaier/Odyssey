...
#include "HscsiConfig.cpp"
#include "SmConfig.cpp"
...
CLASSENTRY("HDM_HSCSI", 10240, 1024, HdmHscsi);
CLASSENTRY("HDM_SCSI_MON", 10240, 1024, ScsiMonitorIsm);
...
HSCSI_CONFIG HdmHscsiParms = {
	{0,0,0},
	HSCSI_CONFIG_VERSION,
	sizeof(HSCSI_CONFIG),
	1,		// initiator mode
	0,		// target mode
	0,		// fairness
	...
	0,		// LUNs
	0,		// PCI window buffers
	0x10004000,// base ISP address
	0,		// interrupt number
	INITIATOR_INSTANCE,	// instance number
	vdnSM	// events to this virtual device
};

#include "SmConfig.h"

SM_CONFIG	ScsiMonParms = {
	{0,0,0},
	SM_CONFIG_VERSION,
	sizeof(SM_CONFIG),
	15,
...
#ifdef HSCSI
VIRTUALENTRY("HDM_HSCSI", TRUE, vdnHSCSI, IOP_HBC0,NO_SLOT, HSCSI_CONFIG, &HdmHscsiParms);
VIRTUALENTRY("HDM_SCSI_MON", TRUE, vdnSM, IOP_HBC0,NO_SLOT, SM_CONFIG, &ScsiMonParms);
#endif
