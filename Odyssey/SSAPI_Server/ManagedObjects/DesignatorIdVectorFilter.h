//************************************************************************
// FILE:		DesignatorIdVectorFilter.h
//
// PURPOSE:		Defines the DesignatorIdVectorFilter object that will be used
//				to filter result sets for ObjectManager::ListIds()
//************************************************************************

#ifndef __ID_VECTOR_FILTER_H__
#define	__ID_VECTOR_FILTER_H__
...
class DesignatorIdVectorFilter : public Filter{

	Container		*m_pValueVector;		// contains pointers to DesignatorId
	int				m_fieldId;
...
DesignatorIdVectorFilter( const ValueSet &valueSet );
...
virtual ~DesignatorIdVectorFilter();
...
static Filter* Ctor( const ValueSet &valueSet ){ 
	return new DesignatorIdVectorFilter( valueSet ); 
}
...
#endif	// __ID_FLOAT_VECTOR_FILTER_H__