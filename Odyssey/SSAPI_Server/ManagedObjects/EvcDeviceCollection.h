//************************************************************************
// FILE:		EvcDeviceCollection.h
//
// PURPOSE:		Defines class EvcDeviceCollection that will be used
//				to group EVC  devices in the O2K product
//************************************************************************

#ifndef __EVC_DEVICE_COLLECTION_H__
#define	__EVC_DEVICE_COLLECTION_H__
...
class EvcDeviceCollection : public DeviceCollection{ 
...
EvcDeviceCollection( ListenManager *pListenManager );
...
virtual ManagedObject* CreateInstance(){ return new EvcDeviceCollection( GetListenManager() ); }
...
#endif // __EVC_DEVICE_COLLECTION_H__