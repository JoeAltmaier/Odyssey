//************************************************************************
// FILE:		PciDeviceCollection.h
//
// PURPOSE:		Defines class PciDeviceCollection that will be used
//				to group PCI resource devices in the O2K product
//************************************************************************

#ifndef __PCI_DEVICE_COLLECTION_H__
#define	__PCI_DEVICE_COLLECTION_H__
...
class PciDeviceCollection : public DeviceCollection{ 
...
PciDeviceCollection( ListenManager *pListenManager );
...
virtual ManagedObject* CreateInstance(){ return new PciDeviceCollection( GetListenManager() ); }
...
#endif // __PCI_DEVICE_COLLECTION_H__