...
#ifndef __STORAGE_ELEMENT_PASS_THRU_TAPE_H__
#define	__STORAGE_ELEMENT_PASS_THRU_TAPE_H__

#include "StorageElementPassThru.h"
struct DeviceDescriptor;


class StorageElementPassThruTape : public StorageElementPassThru {
...
StorageElementPassThruTape( ListenManager *pListenManager, ObjectManager *pManager );
...
virtual ManagedObject* CreateInstance(){ return new StorageElementPassThruTape( GetListenManager(), GetManager() ); }
...
virtual ~StorageElementPassThruTape();
...
#endif	// __STORAGE_ELEMENT_PASS_THRU_TAPE_H__