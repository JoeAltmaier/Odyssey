...
// FILE:		ExternalPort.h
//
// PURPOSE:		Defines an abstract base class for external ports
//************************************************************************

#ifndef __EXTERNAL_PORT_H__
#define	__EXTERNAL_PORT_H__
...
class ExternalPort : public ManagedObject, public StatusReporterInterface {
...
ExternalPort( ListenManager *pListenManager, U32 classType );
